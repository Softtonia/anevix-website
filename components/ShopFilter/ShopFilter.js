...
const ShopFilter = () => {
  ...
  const [selectedWaistSize, setSelectedWaistSize] =
    useState(null);

  const [selectedGeneralSize, setSelectedGeneralSize] =
    useState(null);
  ...
  const filteredProducts = useMemo(() => {
    ...
    let products = availableProducts.filter(
      (product) => {
        ...
        if (
          selectedWaistSize &&
          product.size !== selectedWaistSize
        ) {
          return false;
        }
        ...
        if (
          selectedGeneralSize &&
          product.size !== selectedGeneralSize
        ) {
          return false;
        }
          ...
          <aside className="shopSidebar">
            ...
            <div className="sidebarCard">
              ...
              <div className="filterSection">
                ...
                <div className="filterList horizontalList">
